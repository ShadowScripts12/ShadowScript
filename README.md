if getgenv().hub then warn("Shadow Hub : Already executed!") return end
getgenv().hub = true
...
if DeviceType == "Mobile" then
    ...
    ImageLabel.Image = "https://th.bing.com/th/id/OIP.LveBwBdZkmYinfzqAjJC3AHaEo?rs=1&pid=ImgDetMain" -- add image here
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Shadow Hub - Premium",
    SubTitle = " (https://discord.gg/R94UUKVXbB)", -- discord link
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/R94UUKVXbB") -- discord link
        end
    })
